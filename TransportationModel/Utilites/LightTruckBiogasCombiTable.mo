...
model LightTruckBiogasCombiTable

  constant String LightTruckBiogasData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/LightTruckBiogasCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = LightTruckBiogasData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end LightTruckBiogasCombiTable;
