...
model HeavyTruckHydrogenDepletionCombiTable

  constant String HeavyTruckHydrogenData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckHydrogenDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = HeavyTruckHydrogenData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end HeavyTruckHydrogenDepletionCombiTable;
