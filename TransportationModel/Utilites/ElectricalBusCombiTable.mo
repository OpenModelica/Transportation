...
model ElectricalBusCombiTable

  constant String ElectricalBus = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/ElectricalBusCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = ElectricalBus, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
