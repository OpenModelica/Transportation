...
model TotalElectricCars
  constant String ElectricCars = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/TotalElectricCars.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = ElectricCars, tableName = "CarPool", tableOnFile = true, verboseRead = false) annotation(
