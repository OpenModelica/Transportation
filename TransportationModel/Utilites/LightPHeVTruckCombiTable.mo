...
model LightPHeVTruckCombiTable

  constant String LightTruckPHeVData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/LightPHeVTruckCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = LightTruckPHeVData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
