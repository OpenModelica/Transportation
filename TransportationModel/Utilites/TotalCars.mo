...
model TotalCars
  constant String TotalCars = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/TotalCars.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = TotalCars, tableName = "Table", tableOnFile = true, verboseRead = false) annotation(
