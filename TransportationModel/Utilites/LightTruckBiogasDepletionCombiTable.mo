...
model LightTruckBiogasDepletionCombiTable

  constant String LightTruckBiogasDepletionData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/LightTruckBiogasDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = LightTruckBiogasDepletionData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end LightTruckBiogasDepletionCombiTable;
