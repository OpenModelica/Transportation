...
model HeavyBioGasTruckCombiTable

  constant String HeavyBioGasTruckData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckBioGasCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = HeavyBioGasTruckData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end HeavyBioGasTruckCombiTable;
