...
model HeavyTruckDieselCombiTable

  constant String HeavyTruckDiesel = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckDieselCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = HeavyTruckDiesel, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end HeavyTruckDieselCombiTable;
