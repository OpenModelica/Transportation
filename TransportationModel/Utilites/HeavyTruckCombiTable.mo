...
model HeavyTruckCombiTable

  constant String HeavyTruck = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = HeavyTruck, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
