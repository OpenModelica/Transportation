...
model LightTruckCombiTable

  constant String LightTruckData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/LightTruckCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = LightTruckData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
