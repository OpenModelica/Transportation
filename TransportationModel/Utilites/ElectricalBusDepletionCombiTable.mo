...
model ElectricalBusDepletionCombiTable

  constant String ElectricalBusDepletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/ElectricalBusDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = ElectricalBusDepletion, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end ElectricalBusDepletionCombiTable;
