...
model LightTruckPHeVDepletionCombiTable

  constant String LightTruckPHeVDepletionData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/LightTruckPHeVDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = LightTruckPHeVDepletionData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end LightTruckPHeVDepletionCombiTable;
