...
model DummyCombitable
  constant String DummyTable = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/DummyData.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = DummyTable, tableName = "Dummy", tableOnFile = true, verboseRead = false) annotation(
