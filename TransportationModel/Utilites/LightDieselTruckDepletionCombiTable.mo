...
model LightDieselTruckDepletionCombiTable

  constant String LightDieselTruckDepletionData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/LightDieselTruckDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = LightDieselTruckDepletionData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end LightDieselTruckDepletionCombiTable;
