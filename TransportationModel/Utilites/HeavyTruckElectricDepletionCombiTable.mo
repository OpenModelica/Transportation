...
model HeavyTruckElectricDepletionCombiTable

  constant String HeavyTruckElectricDepletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckElectricDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = HeavyTruckElectricDepletion, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end HeavyTruckElectricDepletionCombiTable;
