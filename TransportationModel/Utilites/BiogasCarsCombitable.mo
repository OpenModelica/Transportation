...
block BiogasCarsCombitable
  
  constant String BiogasData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/BioVehicle.txt");
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = BiogasData, tableName = "Table", tableOnFile = true, verboseExtrapolation = true, verboseRead = false)  annotation(
