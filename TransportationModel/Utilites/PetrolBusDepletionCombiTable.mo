...
model PetrolBusDepletionCombiTable

  constant String PetrolBusDepletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/PetrolBusDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = PetrolBusDepletion, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end PetrolBusDepletionCombiTable;
