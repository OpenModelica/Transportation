...
model HeavyBioGasTruckDepletionCombiTable

  constant String HeavyTruckBioGasDepletionData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckBioGasDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = HeavyTruckBioGasDepletionData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end HeavyBioGasTruckDepletionCombiTable;
