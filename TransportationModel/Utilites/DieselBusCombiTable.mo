...
model DieselBusCombiTable

  constant String DieselBus = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/DieselBusCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = DieselBus, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
