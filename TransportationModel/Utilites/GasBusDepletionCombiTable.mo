...
model GasBusDepletionCombiTable

  constant String GasBusDepletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/GasBusDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = GasBusDepletion, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
