...
model GasBusCombiTable

  constant String GasBus = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/GasBusCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = GasBus, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
