...
model DieselCarDepletionCombiTable

  constant String DieselDepletionData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/DieselDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = DieselDepletionData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end DieselCarDepletionCombiTable;
