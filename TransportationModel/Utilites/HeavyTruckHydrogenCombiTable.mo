...
model HeavyTruckHydrogenCombiTable

  constant String HeavyTruckHydrogenData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckHydrogenCombiTable.txt");
...
end HeavyTruckHydrogenCombiTable;
