...
block PetrolLogicCombitable
  
  constant String PetrolData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/PetrolCombiTable.txt");
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = PetrolData, tableName = "Table", tableOnFile = true, verboseExtrapolation = true, verboseRead = false)  annotation(
