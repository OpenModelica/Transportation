...
model HeavyTruckDepletionCombiTable

  constant String HeavyTruckDepletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = HeavyTruckDepletion, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end HeavyTruckDepletionCombiTable;
