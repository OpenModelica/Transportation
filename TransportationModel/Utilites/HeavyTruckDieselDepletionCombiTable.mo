...
model HeavyTruckDieselDepletionCombiTable

  constant String HeavyTruckDieselData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckDieselDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = HeavyTruckDieselData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end HeavyTruckDieselDepletionCombiTable;
