...
model TotalPHeVCars
  constant String PHeVCars = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/TotalPHeVCars.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = PHeVCars, tableName = "CarPool", tableOnFile = true, verboseRead = false) annotation(
