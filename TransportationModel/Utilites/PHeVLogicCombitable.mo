...
block PHeVLogicCombitable
  constant String PHeVData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/PHeVLogicCombiTable.txt");
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = PHeVData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
