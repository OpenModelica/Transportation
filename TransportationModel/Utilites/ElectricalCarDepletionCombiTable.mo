...
model ElectricalCarDepletionCombiTable

  constant String ElectricalDepletionData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/ElectricDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = ElectricalDepletionData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end ElectricalCarDepletionCombiTable;
