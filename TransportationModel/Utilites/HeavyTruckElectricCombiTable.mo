...
model HeavyTruckElectricCombiTable

  constant String HeavyTruckElectric = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/HeavyTruckElectricCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = HeavyTruckElectric, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end HeavyTruckElectricCombiTable;
