...
model PHeVCarDepletionCombiTable

  constant String PHeVDepletionData = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/PHeVDepletionCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = PHeVDepletionData, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
...
end PHeVCarDepletionCombiTable;
