...
block ElectricalLogicCombitable

  constant String ElectricCar = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/ElectricLogicCombiTable.txt");
  ...
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = ElectricCar, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
