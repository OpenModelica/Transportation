...
model PetrolBusCombiTable

  constant String PetrolBus = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/PetrolBusCombiTable.txt");

  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(columns = 2:2, fileName = PetrolBus, tableName = "Table", tableOnFile = true, verboseRead = false)  annotation(
