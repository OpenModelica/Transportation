...
model TransportationHub
  ...
  TransportationModel.Components.VehiclePool BioCars(ConversionPercentage = TP.ConversionPercentageforBioCar, ConversionYear = TP.ConversionYearforBioCar,InitialLevel = TP.InitialLevelofBiogasCars, Trigger = TP.BiogasCars_flag) annotation(
    Placement(visible = true, transformation(origin = {-143, 135}, extent = {{-13, -13}, {13, 13}}, rotation = 0)));
  TransportationModel.Components.VehiclePool PetrolCars(ConversionPercentage = TP.ConversionPercentageforPetrolCar,ConversionYear = TP.ConversionYearforPetrolCar,InitialLevel = TP.InitialLevelofPetrolCar, Trigger = TP.PetrolCars_flag) annotation(
    Placement(visible = true, transformation(origin = {-133, 117}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  TransportationModel.Components.VehiclePool DieselCars(ConversionPercentage = TP.ConversionPercentageforDieselCar, ConversionYear = TP.ConversionYearforDieselCar,InitialLevel = TP.InitialLevelofDieselCar, Trigger = TP.DieselCars_flag) annotation(
    Placement(visible = true, transformation(origin = {-144, 96}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
  TransportationModel.Components.VehiclePool PHeVCars(ConversionPercentage = TP.ConversionPercentageforPHeVCar, ConversionYear = TP.ConversionYearforPHeVCar,InitialLevel = TP.InitialLevelofPHeVCar, Trigger = TP.PHeVCars_flag) annotation(
    Placement(visible = true, transformation(origin = {-131, 79}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  TransportationModel.Components.ElectricalVehiclePool ElectricCars(InitialLevel = TP.InitialLevelofEV) annotation(
    Placement(visible = true, transformation(origin = {-138, 60}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
 //Cars Rate Equations
  TransportationModel.LogicBox.RateLogic BioCarsRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/BioCarsDepletionRate.txt"), FossilBanYear = TP.BiogasCarBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/BioCarsGrowthRate.txt"), CombitableFlag = TP.CarBiogasRateLogicFlag  )  annotation(
    Placement(visible = true, transformation(origin = {-210, 136}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic PetrolCarRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/PetrolCarsDepletionRate.txt"), FossilBanYear = TP.PetrolCarBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/PetrolCarsGrowthRate.txt"), CombitableFlag = TP.CarPetrolRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-210, 116}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic DieselCarRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/DieselCarsDepletionRate.txt"),FossilBanYear = TP.DieselCarBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/DieselCarsGrowthRate.txt"), CombitableFlag = TP.CarDieselRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-210, 96}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic PHeVCarRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/PHeVCarsDepletionRate.txt"),FossilBanYear = TP.PHeVCarBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/PHeVCarsGrowthRate.txt"), CombitableFlag = TP.CarPHeVRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-210, 76}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum GrowthinElectric_Cars_AfterFossilBan(nu = 10)  annotation(
    Placement(visible = true, transformation(origin = {-166, 74}, extent = {{-2, -2}, {2, 2}}, rotation = 0)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic ElectricCarRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/ElectricCarsGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/ElectricCarsDepletionRate.txt"),CombitableFlag = TP.CarElectricRateLogicFlag)  annotation(
 ...
 //Light Truck Equations
  TransportationModel.LogicBox.RateLogic LightPetrolTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightPetrolTruckDepletionRate.txt"),FossilBanYear = TP.LightPetrolTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightPetrolTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckPetrolRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-211, 37}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic LightDieselTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightDieselTruckDepletionRate.txt"), FossilBanYear = TP.LightDieselTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightDieselTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckDieselRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-211, 17}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic LightPHeVTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightPHeVTruckDepletionRate.txt"),FossilBanYear = TP.LightPHeVTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightPHeVTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckPHeVRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-211, -3}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic LightBioGasRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightBiogasTruckDepletionRate.txt"),FossilBanYear = TP.LightBioGasTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightBiogasTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckPHeVRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-211, -23}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic LightElectricTruckRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightElectricTruckGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/LightElectricTruckDepletionRate.txt"),CombitableFlag = TP.LightTruckElectricRateLogicFlag)  annotation(
...
//Heavy Truck Equations
  TransportationModel.LogicBox.RateLogic HeavyPetrolTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyPetrolTruckDepletionRate.txt"),FossilBanYear = TP.HeavyPetrolTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyPetrolTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckPetrolRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-211, -75}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic HeavyDieselTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyDieselTruckDepletionRate.txt"),FossilBanYear = TP.HeavyDieselTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyDieselTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckDieselRateLogicFlag  )  annotation(
    Placement(visible = true, transformation(origin = {-211, -91}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic HeavyHydrogenTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyHydrogenTruckDepletionRate.txt"),FossilBanYear = TP.HeavyHydrogenTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyHydrogenTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckHydrogenRateLogicFlag  )  annotation(
    Placement(visible = true, transformation(origin = {-211, -107}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic HeavyBioGasTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyBioGasTruckDepletionRate.txt"),FossilBanYear = TP.HeavyBiogasTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyBioGasTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckBiogasRateLogicFlag  )  annotation(
    Placement(visible = true, transformation(origin = {-211, -123}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic HeavyElectricTuckRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyElectricTruckGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HeavyElectricTruckDepletionRate.txt"),CombitableFlag = TP.HeavyTruckElectricRateLogicFlag  )  annotation(
...
//Total Vehicles
  Modelica.Blocks.Math.MultiSum TotalHeavyTrucks(nu = 5)  annotation(
    Placement(visible = true, transformation(origin = {6, 150}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalBuses(nu = 4) annotation(
    Placement(visible = true, transformation(origin = {126, 168}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalLightTrucks(nu = 5)  annotation(
    Placement(visible = true, transformation(origin = {-38, 168}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
//Buses Rate Equations
  TransportationModel.LogicBox.RateLogic DieselBusRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/DieselBusDepletionRate.txt"),FossilBanYear = TP.DieselBusBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/DieselBusGrowthRate.txt"),CombitableFlag = TP.DieselBusRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-211, -159}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic GasBusRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/GasBusDepletionRate.txt"),FossilBanYear = TP.GasBusBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/GasBusGrowthRate.txt"),CombitableFlag = TP.GasBusRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-171, -179}, extent = {{-7, -7}, {7, 7}}, rotation = 90)));
  TransportationModel.LogicBox.RateLogic HydrogenBusRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HydrogenBusDepletionRate.txt"),FossilBanYear = TP.HydrogenBusBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/HydrogenBusGrowthRate.txt"),CombitableFlag = TP.HydrogenBusRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-135, -179}, extent = {{-7, -7}, {7, 7}}, rotation = 90)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic ElectricBusRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/ElectricalBusGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case2/ElectricalBusDepletionRate.txt"),CombitableFlag = TP.ElectricBusRateLogicFlag)  annotation(
 ...
 TransportationModel.LogicBox.ConversionProgramme PHeVCarsconversionProgramme annotation(
    Placement(visible = true, transformation(origin = {-180, 84}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
...
protected Modelica.Blocks.Math.MultiSum GrowthinElectricBusesAfterFossilBan(nu = 6) annotation(
...
equation
 connect(TotalCars.y, BioCars.TotalVehicles) annotation(
    Line(points = {{-80, 158}, {-72, 158}, {-72, 132}, {-131, 132}}, color = {0, 0, 127}));
 connect(TotalCars.y, PetrolCars.TotalVehicles) annotation(
    Line(points = {{-80, 158}, {-72, 158}, {-72, 113}, {-119, 113}}, color = {0, 0, 127}));
 connect(TotalCars.y, DieselCars.TotalVehicles) annotation(
    Line(points = {{-80, 158}, {-72, 158}, {-72, 92.5}, {-131, 92.5}}, color = {0, 0, 127}));
 connect(TotalCars.y, PHeVCars.TotalVehicles) annotation(
    Line(points = {{-80, 158}, {-72, 158}, {-72, 75}, {-117, 75}}, color = {0, 0, 127}));
 connect(TotalCars.y, ElectricCars.TotalVehicles) annotation(
    Line(points = {{-80, 158}, {-72, 158}, {-72, 56}, {-123, 56}}, color = {0, 0, 127}));
 ...
 connect(TotalLightTrucks.y, LightDieselTrucks.TotalVehicles) annotation(
    Line(points = {{-26, 168}, {-20, 168}, {-20, 6.5}, {-81, 6.5}}, color = {0, 0, 127}));
 ...
 connect(HeavyElectricTruck.VehicleNos, VehiclesPoolBus.S015_HeavyElectricTruck) annotation(
  ...
  connect(DieselBus.VehicleNos, TotalBuses.u[1]) annotation(
    Line(points = {{100, 30}, {104, 30}, {104, 168}, {116, 168}}, color = {0, 0, 127}));
  connect(TotalBuses.y, DieselBus.TotalVehicles) annotation(
    Line(points = {{138, 168}, {140, 168}, {140, 26}, {100, 26}}, color = {0, 0, 127}));
  connect(GasBus.VehicleNos, TotalBuses.u[2]) annotation(
    Line(points = {{100, -8}, {104, -8}, {104, 168}, {116, 168}}, color = {95, 0, 191}));
  connect(HydrogenBus.VehicleNos, TotalBuses.u[3]) annotation(
    Line(points = {{100, -48}, {104, -48}, {104, 168}, {116, 168}}, color = {95, 0, 191}));
  connect(ElectricBus.VehicleNos, TotalBuses.u[4]) annotation(
    Line(points = {{100, -83}, {104, -83}, {104, 168}, {116, 168}}, color = {95, 0, 191}));
  ...
  connect(TotalBuses.y, GasBus.TotalVehicles) annotation(
    Line(points = {{138, 168}, {140, 168}, {140, -12}, {100, -12}}, color = {0, 0, 127}));
  connect(TotalBuses.y, HydrogenBus.TotalVehicles) annotation(
    Line(points = {{138, 168}, {140, 168}, {140, -52}, {100, -52}}, color = {0, 0, 127}));
  connect(TotalBuses.y, ElectricBus.TotalVehicles) annotation(
    Line(points = {{138, 168}, {140, 168}, {140, -86}, {100, -86}}, color = {0, 0, 127}));
 ...
 connect(DepletionInCars.y, ElectricCars.InDepletionRate) annotation(
    Line(points = {{-164, 64}, {-162, 64}, {-162, 58}, {-154, 58}}, color = {0, 0, 127}));
 ...
 connect(PetrolCarsconversionProgramme.VehicleGrowhRate, PetrolCars.InGrowthRate) annotation(
    Line(points = {{-176, 125}, {-166, 125}, {-166, 119}, {-147, 119}}, color = {0, 0, 127}));
 connect(PetrolCarsconversionProgramme.VehicleDepletionRate, PetrolCars.InDepletionRate) annotation(
    Line(points = {{-176, 124}, {-166, 124}, {-166, 115}, {-147, 115}}, color = {0, 0, 127}));
 ...
 connect(DieselCarsconversionProgramme.VehicleGrowhRate, DieselCars.InGrowthRate) annotation(
    Line(points = {{-176, 101}, {-166.5, 101}, {-166.5, 98}, {-157, 98}}, color = {0, 0, 127}));
 connect(DieselCarsconversionProgramme.VehicleDepletionRate, DieselCars.InDepletionRate) annotation(
    Line(points = {{-176, 100}, {-170, 100}, {-170, 94}, {-157, 94}}, color = {0, 0, 127}));
 ...
 connect(PHeVCarRateLogic.GrowthRate, PHeVCarsconversionProgramme.GrowthRate) annotation(
    Line(points = {{-200, 82}, {-188, 82}, {-188, 87}, {-185, 87}}, color = {0, 0, 127}));
 connect(PHeVCarRateLogic.DepletionRate, PHeVCarsconversionProgramme.DepletionRate) annotation(
    Line(points = {{-200, 76}, {-190, 76}, {-190, 81}, {-185, 81}}, color = {0, 0, 127}));
 ...
 connect(GasBusRateLogic.GrowthRate, GasBusconversionProgramme.GrowthRate) annotation(
    Line(points = {{-176, -170}, {-176, -154}, {24, -154}, {24, -3}, {29, -3}}, color = {0, 0, 127}));
 connect(GasBusRateLogic.DepletionRate, GasBusconversionProgramme.DepletionRate) annotation(
    Line(points = {{-170, -170}, {-170, -160}, {24, -160}, {24, -9}, {29, -9}}, color = {0, 0, 127}));
 ...
 connect(HeavyPetrolTruck.VehicleNos, TotalHeavyTrucks.u[1]) annotation(
    Line(points = {{-74, -72}, {-18, -72}, {-18, 150}, {-4, 150}}, color = {0, 0, 127}));
 connect(HeavyDieselTruck.VehicleNos, TotalHeavyTrucks.u[2]) annotation(
    Line(points = {{-110, -86}, {-18, -86}, {-18, 150}, {-4, 150}}, color = {95, 0, 191}));
 connect(HeavyHydrogenTruck.VehicleNos, TotalHeavyTrucks.u[3]) annotation(
    Line(points = {{-64, -102}, {-18, -102}, {-18, 150}, {-4, 150}}, color = {0, 0, 127}));
 connect(HeavyBioGasTruck.VehicleNos, TotalHeavyTrucks.u[4]) annotation(
    Line(points = {{-108, -120}, {-18, -120}, {-18, 150}, {-4, 150}}, color = {95, 0, 191}));
 connect(HeavyElectricTruck.VehicleNos, TotalHeavyTrucks.u[5]) annotation(
    Line(points = {{-78, -138}, {-18, -138}, {-18, 150}, {-4, 150}}, color = {95, 0, 191}));
 connect(PetrolCarsconversionProgramme.ToElectricVehicleGrowth, GrowthinElectric_Cars_AfterFossilBan.u[9]) annotation(
    Line(points = {{-176, 120}, {-172, 120}, {-172, 74}, {-168, 74}}, color = {0, 0, 127}));
 connect(DieselCarRateLogic.GrowthRate, DieselCarsconversionProgramme.GrowthRate) annotation(
    Line(points = {{-200, 102}, {-184, 102}}, color = {0, 0, 127}));
 connect(DieselCarRateLogic.DepletionRate, DieselCarsconversionProgramme.DepletionRate) annotation(
    Line(points = {{-200, 96}, {-192, 96}, {-192, 94}, {-184, 94}}, color = {0, 0, 127}));
 connect(DieselCarRateLogic.GrowthToElectricVehicle, GrowthinElectric_Cars_AfterFossilBan.u[10]) annotation(
