...
model TransportationHub
 extends TransportationModel.Icons.TransportationIcon;
  ...
  TransportationModel.Components.VehiclePool DieselCars(ConversionPercentage = TP.ConversionPercentageforDieselCar, ConversionYear = TP.ConversionYearforDieselCar,InitialLevel = TP.InitialLevelofDieselCar, Trigger = TP.DieselCars_flag) annotation(
    Placement(visible = true, transformation(origin = {-144, 98}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
 ...
 //Cars Rate Equations
  TransportationModel.LogicBox.RateLogic BioCarsRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/BioCarsDepletionRate.txt"), FossilBanYear = TP.BiogasCarBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/BioCarsGrowthRate.txt"),CombitableFlag = TP.CarBiogasRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-210, 136}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic PetrolCarRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/PetrolCarsDepletionRate.txt"), FossilBanYear = TP.PetrolCarBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/PetrolCarsGrowthRate.txt"),CombitableFlag = TP.CarPetrolRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-210, 116}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic DieselCarRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/DieselCarsDepletionRate.txt"),FossilBanYear = TP.DieselCarBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/DieselCarsGrowthRate.txt"),CombitableFlag = TP.CarDieselRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-210, 96}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic PHeVCarRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/PHeVCarsDepletionRate.txt"),FossilBanYear = TP.PHeVCarBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/PHeVCarsGrowthRate.txt"),CombitableFlag = TP.CarPHeVRateLogicFlag)  annotation(
  ...
  TransportationModel.LogicBox.ElectricVehicleRateLogic ElectricCarRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/ElectricCarsGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/ElectricCarsDepletionRate.txt"),CombitableFlag = TP.CarElectricRateLogicFlag)  annotation(
 ...
 //Light Truck Equations
  TransportationModel.LogicBox.RateLogic LightPetrolTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightPetrolTruckDepletionRate.txt"),FossilBanYear = TP.LightPetrolTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightPetrolTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckPetrolRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-211, 37}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic LightDieselTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightDieselTruckDepletionRate.txt"), FossilBanYear = TP.LightDieselTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightDieselTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckDieselRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, 17}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic LightPHeVTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightPHeVTruckDepletionRate.txt"),FossilBanYear = TP.LightPHeVTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightPHeVTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckPHeVRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -3}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic LightBioGasRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightBiogasTruckDepletionRate.txt"),FossilBanYear = TP.LightBioGasTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightBiogasTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckBiogasRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -23}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic LightElectricTruckRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightElectricTruckGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/LightElectricTruckDepletionRate.txt"),CombitableFlag = TP.LightTruckElectricRateLogicFlag)  annotation(
...
//Heavy Truck Equations
  TransportationModel.LogicBox.RateLogic HeavyPetrolTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyPetrolTruckDepletionRate.txt"),FossilBanYear = TP.HeavyPetrolTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyPetrolTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckPetrolRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -75}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic HeavyDieselTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyDieselTruckDepletionRate.txt"),FossilBanYear = TP.HeavyDieselTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyDieselTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckDieselRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -91}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic HeavyHydrogenTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyHydrogenTruckDepletionRate.txt"),FossilBanYear = TP.HeavyHydrogenTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyHydrogenTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckHydrogenRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -107}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic HeavyBioGasTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyBioGasTruckDepletionRate.txt"),FossilBanYear = TP.HeavyBiogasTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyBioGasTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckBiogasRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -123}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic HeavyElectricTuckRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyElectricTruckGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HeavyElectricTruckDepletionRate.txt"),CombitableFlag = TP.HeavyTruckElectricRateLogicFlag)  annotation(
...
//Buses Rate Equations
  TransportationModel.LogicBox.RateLogic DieselBusRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/DieselBusDepletionRate.txt"),FossilBanYear = TP.DieselBusBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/DieselBusGrowthRate.txt"),CombitableFlag = TP.DieselBusRateLogicFlag )  annotation(
    Placement(visible = true, transformation(origin = {-211, -159}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic GasBusRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/GasBusDepletionRate.txt"),FossilBanYear = TP.GasBusBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/GasBusGrowthRate.txt"),CombitableFlag = TP.GasBusRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-171, -179}, extent = {{-7, -7}, {7, 7}}, rotation = 90)));
  TransportationModel.LogicBox.RateLogic HydrogenBusRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HydrogenBusDepletionRate.txt"),FossilBanYear = TP.HydrogenBusBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/HydrogenBusGrowthRate.txt"),CombitableFlag = TP.HydrogenBusRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-135, -179}, extent = {{-7, -7}, {7, 7}}, rotation = 90)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic ElectricBusRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/ElectricalBusGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case3/ElectricalBusDepletionRate.txt"),CombitableFlag = TP.ElectricBusRateLogicFlag)  annotation(
...
equation
 ...
 connect(TotalCars.y, DieselCars.TotalVehicles) annotation(
    Line(points = {{-80, 158}, {-72, 158}, {-72, 94.5}, {-131, 94.5}}, color = {0, 0, 127}));
 ...
 connect(HeavyElectricTruck.VehicleNos, VehiclesPoolBus.S015_HeavyElectricTruck) annotation(
  ...
  connect(StartSimulationTime.y, BioCarsRateLogic.InputSimulationTime) annotation(
    Line(points = {{-283, 0}, {-260, 0}, {-260, 136}, {-220, 136}}, color = {0, 0, 127}));
 ...
 connect(StartSimulationTime.y, LightElectricTruckRateLogic.InputSimulationTime) annotation(
    Line(points = {{-282, 0}, {-260, 0}, {-260, -43}, {-219, -43}}, color = {0, 0, 127}));
 ...
 connect(DieselCars.VehicleNos, VehiclesPoolBus.S003_DieselCars) annotation(
    Line(points = {{-131, 98}, {200, 98}, {200, 0}}, color = {170, 0, 0}));
 ...
 connect(DieselCars.VehicleNos, TotalCars.u[3]) annotation(
    Line(points = {{-131, 98}, {-112, 98}, {-112, 158}, {-102, 158}}, color = {0, 0, 127}));
 ...
 connect(DieselCarsconversionProgramme.VehicleGrowhRate, DieselCars.InGrowthRate) annotation(
    Line(points = {{-176, 101}, {-166.5, 101}, {-166.5, 100}, {-157, 100}}, color = {0, 0, 127}));
 connect(DieselCarsconversionProgramme.VehicleDepletionRate, DieselCars.InDepletionRate) annotation(
    Line(points = {{-176, 100}, {-170, 100}, {-170, 96}, {-157, 96}}, color = {0, 0, 127}));
 ...
 connect(DieselCars.ToEV, multiSum.u[3]) annotation(
    Line(points = {{-130, 96}, {-70, 96}, {-70, 46}, {-86, 46}}, color = {0, 0, 127}));
 ...
 connect(LightElectricTruckRateLogic.DepletionRate, DeleltionInLightTruck.u[1]) annotation(
    Line(points = {{-203, -47}, {-182, -47}, {-182, -48}, {-162, -48}}, color = {0, 0, 127}));
 ...
 connect(DieselCars.VehicleNos, DieselCarsconversionProgramme.VehicleInput) annotation(
    Line(points = {{-131, 98}, {-126, 98}, {-126, 104}, {-168, 104}, {-168, 98}, {-176, 98}}, color = {95, 0, 191}));
 ...
 connect(HeavyPetrolTruck.VehicleNos, TotalHeavyTrucks.u[1]) annotation(
    Line(points = {{-74, -72}, {-18, -72}, {-18, 150}, {-4, 150}}, color = {95, 0, 191}));
 ...
 connect(HeavyHydrogenTruck.VehicleNos, TotalHeavyTrucks.u[3]) annotation(
    Line(points = {{-64, -102}, {-18, -102}, {-18, 150}, {-4, 150}}, color = {95, 0, 191}));
 ...
 connect(HeavyElectricTruck.VehicleNos, TotalHeavyTrucks.u[5]) annotation(
    Line(points = {{-78, -138}, {-18, -138}, {-18, 150}, {-4, 150}}, color = {0, 0, 127}));
 ...
 connect(PetrolCarsconversionProgramme.ToElectricVehicleGrowth, GrowthinElectric_Cars_AfterFossilBan.u[10]) annotation(
