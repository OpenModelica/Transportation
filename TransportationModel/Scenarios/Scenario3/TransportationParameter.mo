...
//Activate Variable Average KM Flag for Bus
  parameter Boolean ActivateVariableAverageKMperDieselBus = true;
  parameter Boolean ActivateVariableAverageKMperHydrogenBus = true;
  parameter Boolean ActivateVariableAverageKMperGasBus = true;
  parameter Boolean ActivateVariableAverageKMperElectricBus= true;
...
//Car co2 Emissions
  ...
  parameter Real ElectricCarGHGEmissionGmperKWh = 0*10^(-12);
