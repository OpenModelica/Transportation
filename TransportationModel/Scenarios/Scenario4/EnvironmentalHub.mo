...
model EnvironmentalHub
  ...
  Modelica.Blocks.Math.MultiSum TotalCars(nu = 5) annotation(
    Placement(visible = true, transformation(origin = {-13, 104}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalLightTrucks(nu = 5) annotation(
    Placement(visible = true, transformation(origin = {-14, 79}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalBuses(nu = 4) annotation(
    Placement(visible = true, transformation(origin = {27.5, 68.5}, extent = {{-5.5, -5.5}, {5.5, 5.5}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalHeavyTruck(nu = 5) annotation(
    Placement(visible = true, transformation(origin = {23.5, 91.5}, extent = {{-5.5, -5.5}, {5.5, 5.5}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalCO2Emission(nu = 38)  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBox BioCars(FossilCombustionEmissionFlag = TP.FossilCombustionFlagforBioCar, BioCombustionEmissionFlag = TP.BioCombustionFlagforBioCar,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/BiogasCarEfficiency.txt"), EnergyperCarPerKM = TP.EnergyUseByBioGasCarperKM, FixedAverageKM = TP.AverageKMBiogasCarRuns, Flag = TP.ActivateVariableAverageKMperBioCar, FossilBanYear = TP.BiogasCarBanYear, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForBioCars, UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforBioCar, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforBioCar)  annotation(
    Placement(visible = true, transformation(origin = {-65.5, 14.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox PetrolCars(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforPetrolCar, BioCombustionEmissionFlag = TP.BioCombustionFlagforPetrolCar,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/petrol_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPetrolCarperKM, FixedAverageKM = TP.AverageKMPetrolCarRuns, Flag = TP.ActivateVariableAverageKMperPetrolCar, FossilBanYear = TP.PetrolCarBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforPetrolCar, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForPetrolCars, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforPetrolCar )  annotation(
    Placement(visible = true, transformation(origin = {-72.5, 7.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox PHeVCars(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforPHeVCar, BioCombustionEmissionFlag = TP.BioCombustionFlagforPHeVCar,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"),BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PHEV_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPHeVCarperKM, FixedAverageKM = TP.AverageKMPHeVCarRuns, Flag = TP.ActivateVariableAverageKMperPHeVCar, FossilBanYear = TP.PHeVCarBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforPHeVCar, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForPHeVCars, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforPHeVCar  )  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBox DieselCars(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforDieselCar, BioCombustionEmissionFlag = TP.BioCombustionFlagforDieselCar,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/DieselBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/DieselBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Diesel_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByDieselCarperKM, FixedAverageKM = TP.AverageKMDieselCarRuns, Flag = TP.ActivateVariableAverageKMperDieselCar, FossilBanYear = TP.DieselCarBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforDieselCar, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Diesel_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Diesel_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForDieselCars, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforDieselCar)  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBox LightPetrolTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforLightPetrolTruck, BioCombustionEmissionFlag = TP.BioCombustionFlagforLightPetrolTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPetrolLightTrucksperKM, FixedAverageKM = TP.AverageKMLightPetrolTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyPetrolTruck, FossilBanYear = TP.LightPetrolTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforLightPetrolTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForLightPetrolTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforLightPetrolTruck)  annotation(
    Placement(visible = true, transformation(origin = {-91.5, -17.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));

  TransportationModel.LogicBox.EnergyLogicBox LightDieselTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforLightDieselTruck,  BioCombustionEmissionFlag = TP.BioCombustionFlagforLightDieselTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByDieselLightTrucksperKM,FixedAverageKM = TP.AverageKMLightDieselTruckRuns, Flag = TP.ActivateVariableAverageKMperLightDieselTruck, FossilBanYear = TP.LightDieselTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforLightDieselTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForLightDieselTrucks , UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforLightDieselTruck )  annotation(
    Placement(visible = true, transformation(origin = {-86.5, -23.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox LightPHeVTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforLightPHeVTruck,  BioCombustionEmissionFlag = TP.BioCombustionFlagforLightPHeVTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightPHeVTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPHeVLightTrucksperKM,FixedAverageKM = TP.AverageKMLightPHeVTruckRuns, Flag = TP.ActivateVariableAverageKMperLightDieselTruck, FossilBanYear = TP.LightPHeVTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforLightPHeVTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForLightPHeVTrucks  , UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforLightPHeVTruck)  annotation(
    Placement(visible = true, transformation(origin = {-91.5, -29.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
  
  TransportationModel.LogicBox.EnergyLogicBox LightBioGasTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforLightBioTruck,  BioCombustionEmissionFlag = TP.BioCombustionFlagforLightBioTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByBioGasLightTrucksperKM,FixedAverageKM = TP.AverageKMLightBiogasTruckRuns, Flag = TP.ActivateVariableAverageKMperLightBioTruck, FossilBanYear = TP.LightBioGasTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforLightBioTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForLightBioGasTrucks   , UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforLightBioTruck)  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBox HeavyPetrolTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHeavyPetrolTruck,  BioCombustionEmissionFlag = TP.BioCombustionFlagforHeavyPetrolTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrol_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPetrolHeavyTrucksperKM,FixedAverageKM = TP.AverageKMHeavyPetrolTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyPetrolTruck, FossilBanYear = TP.HeavyPetrolTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHeavyPetrolTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHeavyPetrolTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHeavyPetrolTruck)  annotation(
    Placement(visible = true, transformation(origin = {-73.5, -47.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox HeavyDieselTrucks( UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHeavyDieselTruck, BioCombustionEmissionFlag = TP.BioCombustionFlagforHeavyDieselTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyDieselTruckBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyDieselTruckBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyDieselTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByDieselHeavyTrucksperKM,FixedAverageKM = TP.AverageKMHeavyDieselTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyDieselTruck, FossilBanYear = TP.HeavyDieselTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHeavyDieselTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyDieselTruck_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyDieselTruck_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHeavyDieselTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHeavyDieselTruck)  annotation(
    Placement(visible = true, transformation(origin = {-81.5, -54.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox HeavyHydrogenTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHeavyHydrogenTruck,  BioCombustionEmissionFlag = TP.BioCombustionFlagforHeavyHydrogenTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyHydrogenTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByHydrogenHeavyTrucksperKM,FixedAverageKM = TP.AverageKMHeavyHydrogenTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyHydrogenTruck, FossilBanYear = TP.HeavyHydrogenTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHeavyHydrogenTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHeavyHydrogenTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHeavyHydrogenTruck )  annotation(
    Placement(visible = true, transformation(origin = {-73.5, -60.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox HeavyBioGasTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHeavyBioTruck,  BioCombustionEmissionFlag = TP.BioCombustionFlagforHeavyBioTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrol_FossilCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByBioGasHeavyTrucksperKM,FixedAverageKM = TP.AverageKMHeavyBiogasTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyBioTruck, FossilBanYear = TP.HeavyBiogasTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHeavyBioTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyTruckPetrol_efficientFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHeavyBioGasTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHeavyBioTruck )  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBox DieselBus( BioCombustionEmissionFlag = TP.BioCombustionFlagforDieselBus,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/PHeVCarEfficiency.txt"), EnergyperCarPerKM = TP.EnergyUseByDieselBusperKM,FixedAverageKM = TP.AverageKMDieselBusRuns, Flag = TP.ActivateVariableAverageKMperDieselBus, FossilBanYear = TP.DieselBusBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforDieselBus,FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForDieselBus, UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforDieselBus, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforDieselBus)  annotation(
    Placement(visible = true, transformation(origin = {-86.5, -83.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox GasBus(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforGasBus, BioCombustionEmissionFlag = TP.BioCombustionFlagforGasBus,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByGasBusperKM,FixedAverageKM = TP.AverageKMGasBusRuns, Flag = TP.ActivateVariableAverageKMperGasBus, FossilBanYear = TP.GasBusBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforGasBus, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForGasBus, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforGasBus )  annotation(
    Placement(visible = true, transformation(origin = {-78.5, -89.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox HydrogenBus(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHydrogenBus,  BioCombustionEmissionFlag = TP.BioCombustionFlagforHydrogenBus,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByHydrogenBusperKM,FixedAverageKM = TP.AverageKMHydrogenBusRuns, Flag = TP.ActivateVariableAverageKMperHydrogenBus, FossilBanYear = TP.HydrogenBusBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHydrogenBus, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightDieselTruckFossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHydrogenBus, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHydrogenBus )  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBoxForElectricalVehicles ElectricalCars( EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/ElectricalCarEfficiency.txt"), EnergyperCarPerKM = TP.EnergyUseByElectricCarperKM,FixedAverageKM = TP.AverageKMElectricCarRuns, Flag = TP.ActivateVariableAverageKMperElectricCar, FossilBanYear = TP.PetrolCarBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforElectricCar, ReducedAverageKMforElectricVehicles = TP.ReducedPercentageForElectricCars, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforElectricCar )  annotation(
    Placement(visible = true, transformation(origin = {-65.5, -10.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
  
  TransportationModel.LogicBox.EnergyLogicBoxForElectricalVehicles LightElectricTrucks( EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByElectricLightTrucksperKM,FixedAverageKM = TP.AverageKMLightElectricTruckRuns, Flag = TP.ActivateVariableAverageKMperLightElectricTruck, FossilBanYear = TP.LightPetrolTruckBanYear, ReducedAverageKMforElectricVehicles = TP.ReducedPercentageForLightElectricTrucks )  annotation(
    Placement(visible = true, transformation(origin = {-91.5, -41.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
  
  TransportationModel.LogicBox.EnergyLogicBoxForElectricalVehicles HeavyElectricTrucks( EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/HeavyElectricTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByElectricHeavyTrucksperKM,FixedAverageKM = TP.AverageKMHeavyElectricTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyElectricTruck, FossilBanYear = TP.HeavyPetrolTruckBanYear, ReducedAverageKMforElectricVehicles = TP.ReducedPercentageForHeavyElectricTrucks )  annotation(
    Placement(visible = true, transformation(origin = {-73.5, -74.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
  
  TransportationModel.LogicBox.EnergyLogicBoxForElectricalVehicles ElectricBus( EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case4/LightBioTruck_efficientFactor.txt"), 
  EnergyperCarPerKM = TP.EnergyUseByElectricBusperKM,FixedAverageKM = TP.AverageKMElectricBusRuns, Flag = TP.ActivateVariableAverageKMperElectricBus, FossilBanYear = TP.DieselBusBanYear, ReducedAverageKMforElectricVehicles = TP.ReducedPercentageForElectricBus )  annotation(
  ...
  Modelica.Blocks.Math.MultiSum TotalCarsCO2Emission(nu = 10) annotation(
    Placement(visible = true, transformation(origin = {29.5, 12.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalLightTrucksCO2Emission(nu = 10) annotation(
    Placement(visible = true, transformation(origin = {30.5, -25.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalHeavyTrucksCO2Emission(nu = 10) annotation(
    Placement(visible = true, transformation(origin = {30.5, -52.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
...
equation
  connect(TotalHeavyTruck.y, DisplayHubPort.NumberofHeavyTrucks) annotation(
    Line(points = {{30, 91.5}, {102.7, 91.5}, {102.7, 20}}, color = {0, 0, 127}));
  connect(TotalLightTrucks.y, DisplayHubPort.NumberofLightTrucks) annotation(
    Line(points = {{-8, 79}, {102.7, 79}, {102.7, 20}}, color = {0, 0, 127}));
  connect(TotalBuses.y, DisplayHubPort.NumberofBuses) annotation(
    Line(points = {{34, 68.5}, {102.7, 68.5}, {102.7, 20}}, color = {0, 0, 127}));
  ...
  connect(HeavyPetrolTruckCO2Emission.y, TotalCO2Emission.u[19]) annotation(
    Line(points = {{-13.9, -37}, {11.1, -37}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HeavyDieselTruckCO2Emission.y, TotalCO2Emission.u[20]) annotation(
    Line(points = {{-13.9, -39}, {11.1, -39}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HeavyBioGasTruckCO2Emission.y, TotalCO2Emission.u[21]) annotation(
    Line(points = {{-13.9, -41}, {11.1, -41}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HeavyHydrogenTruckCO2Emission.y, TotalCO2Emission.u[22]) annotation(
    Line(points = {{-13.9, -43}, {11.1, -43}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HeavyPetrolTruckCO2EmissionUpstream.y, TotalCO2Emission.u[23]) annotation(
    Line(points = {{-13.9, -49}, {11.1, -49}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HeavyDieselTruckCO2EmissionUpstream.y, TotalCO2Emission.u[24]) annotation(
    Line(points = {{-13.9, -51}, {11.1, -51}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HeavyHydrogenTruckCO2EmissionUpstream.y, TotalCO2Emission.u[25]) annotation(
    Line(points = {{-13.9, -53}, {11.1, -53}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HeavyBioGasTruckCO2EmissionUpstream.y, TotalCO2Emission.u[26]) annotation(
    Line(points = {{-13.9, -55}, {11.1, -55}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HeavyElectricTruckCO2EmissionUpstream.y, TotalCO2Emission.u[27]) annotation(
    Line(points = {{-13.9, -57}, {11.1, -57}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(DieselBusCO2Emission.y, TotalCO2Emission.u[28]) annotation(
    Line(points = {{-13.9, -63}, {11.1, -63}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(GasBusCO2Emission.y, TotalCO2Emission.u[29]) annotation(
    Line(points = {{-13.9, -65}, {11.1, -65}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HydrogenBusCO2Emission.y, TotalCO2Emission.u[30]) annotation(
    Line(points = {{-13.9, -67}, {11.1, -67}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(ElectricBusCO2Emission.y, TotalCO2Emission.u[31]) annotation(
    Line(points = {{-13.9, -69}, {11.1, -69}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(DieselBusCO2EmissionUpstream.y, TotalCO2Emission.u[32]) annotation(
    Line(points = {{-13.9, -73}, {11.1, -73}, {11.1, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(GasBusCO2EmissionUpstream.y, TotalCO2Emission.u[33]) annotation(
  ...
  connect(TotalHeavyPetrolTruckCombustionEnergy.y, HeavyPetrolTruckCO2Emission.u) annotation(
    Line(points = {{-65.9, -47}, {-42.9, -47}, {-42.9, -37}, {-15.9, -37}}, color = {0, 0, 127}));
  connect(TotalHeavyDieselTruckCombustionEnergy.y, HeavyDieselTruckCO2Emission.u) annotation(
    Line(points = {{-72.9, -53}, {-42.9, -53}, {-42.9, -39}, {-15.9, -39}}, color = {0, 0, 127}));
  connect(TotalHeavyHydrogenTruckCombustionEnergy.y, HeavyBioGasTruckCO2Emission.u) annotation(
    Line(points = {{-65.9, -59}, {-42.9, -59}, {-42.9, -41}, {-15.9, -41}}, color = {0, 0, 127}));
  connect(TotalHeavyBioGasTruckCombustionEnergy.y, HeavyHydrogenTruckCO2Emission.u) annotation(
    Line(points = {{-72.9, -66}, {-42.9, -66}, {-42.9, -43}, {-15.9, -43}}, color = {0, 0, 127}));
 ...
 connect(PHeVCars.BioCombustion, TotalPHeVCarCombustionEnergy.u1) annotation(
    Line(points = {{-70, -3}, {-65.875, -3}, {-65.875, -2}, {-61.75, -2}}, color = {0, 0, 127}));
 connect(PHeVCars.FossilCombustion, TotalPHeVCarCombustionEnergy.u2) annotation(
    Line(points = {{-70, -2}, {-61.75, -2}, {-61.75, -4}}, color = {0, 0, 127}));
  ...
  connect(ElectricCarsCO2EmissionsUpstream.y, TotalCarsCO2Emission.u[10]) annotation(
    Line(points = {{-14, -5}, {20, -5}, {20, 13}, {27, 13}}, color = {0, 0, 127}));
  connect(TotalCarsCO2Emission.y, DisplayHubPort.TotalCarCO2Emission) annotation(
    Line(points = {{32, 13}, {103, 13}, {103, 20}}, color = {0, 0, 127}));
 connect(LightPetrolTrucksCO2Emissions.y, TotalLightTrucksCO2Emission.u[1]) annotation(
    Line(points = {{-14, -11}, {20, -11}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(LightDieselTruckCO2Emissions.y, TotalLightTrucksCO2Emission.u[2]) annotation(
    Line(points = {{-14, -13}, {20, -13}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(LightPHeVTrucksCO2Emissions.y, TotalLightTrucksCO2Emission.u[3]) annotation(
    Line(points = {{-14, -15}, {20, -15}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(LightBioGasTrucksCO2Emissions.y, TotalLightTrucksCO2Emission.u[4]) annotation(
    Line(points = {{-14, -17}, {20, -17}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(LightElectricTrucksCO2Emissions.y, TotalLightTrucksCO2Emission.u[5]) annotation(
    Line(points = {{-14, -19}, {20, -19}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(LightPetrolTruckCO2EmissionUpstream.y, TotalLightTrucksCO2Emission.u[6]) annotation(
    Line(points = {{-14, -23}, {20, -23}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(LightPHeVTruckCO2EmissionUpstream.y, TotalLightTrucksCO2Emission.u[7]) annotation(
    Line(points = {{-14, -27}, {20, -27}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(LightBioGasTruckCO2EmissionUpstream.y, TotalLightTrucksCO2Emission.u[8]) annotation(
    Line(points = {{-14, -29}, {20, -29}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(LightElectricTruckCO2EmissionUpstream.y, TotalLightTrucksCO2Emission.u[9]) annotation(
    Line(points = {{-14, -31}, {20, -31}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(LightDieselTruckCO2EmissionUpstream.y, TotalLightTrucksCO2Emission.u[10]) annotation(
    Line(points = {{-14, -25}, {20, -25}, {20, -25.5}, {28, -25.5}}, color = {0, 0, 127}));
 connect(TotalLightTrucksCO2Emission.y, DisplayHubPort.TotalLightTrucksCO2Emission) annotation(
    Line(points = {{33, -25.5}, {103, -25.5}, {103, 20}}, color = {0, 0, 127}));
  connect(HeavyPetrolTruckCO2Emission.y, TotalHeavyTrucksCO2Emission.u[1]) annotation(
    Line(points = {{-14, -37}, {20, -37}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(HeavyDieselTruckCO2Emission.y, TotalHeavyTrucksCO2Emission.u[2]) annotation(
    Line(points = {{-14, -39}, {20, -39}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(HeavyBioGasTruckCO2Emission.y, TotalHeavyTrucksCO2Emission.u[3]) annotation(
    Line(points = {{-14, -41}, {20, -41}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(HeavyElectricTruckCO2Emission.y, TotalCO2Emission.u[38]) annotation(
    Line(points = {{-14, -45}, {11, -45}, {11, -7}, {53, -7}}, color = {0, 0, 127}));
  connect(HeavyHydrogenTruckCO2Emission.y, TotalHeavyTrucksCO2Emission.u[4]) annotation(
    Line(points = {{-14, -43}, {20, -43}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(HeavyElectricTruckCO2Emission.y, TotalHeavyTrucksCO2Emission.u[5]) annotation(
    Line(points = {{-14, -45}, {20, -45}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(HeavyPetrolTruckCO2EmissionUpstream.y, TotalHeavyTrucksCO2Emission.u[6]) annotation(
    Line(points = {{-14, -49}, {20, -49}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(HeavyDieselTruckCO2EmissionUpstream.y, TotalHeavyTrucksCO2Emission.u[7]) annotation(
    Line(points = {{-14, -51}, {20, -51}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(HeavyHydrogenTruckCO2EmissionUpstream.y, TotalHeavyTrucksCO2Emission.u[8]) annotation(
    Line(points = {{-14, -53}, {20, -53}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(HeavyBioGasTruckCO2EmissionUpstream.y, TotalHeavyTrucksCO2Emission.u[9]) annotation(
    Line(points = {{-14, -55}, {20, -55}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(HeavyElectricTruckCO2EmissionUpstream.y, TotalHeavyTrucksCO2Emission.u[10]) annotation(
    Line(points = {{-14, -57}, {20, -57}, {20, -52.5}, {28, -52.5}}, color = {0, 0, 127}));
  connect(TotalHeavyTrucksCO2Emission.y, DisplayHubPort.TotalHeavyTrucksCO2Emission) annotation(
    Line(points = {{33, -52}, {103, -52}, {103, 20}}, color = {0, 0, 127}));
  connect(DieselBusCO2Emission.y, TotalBusCO2Emssion.u[1]) annotation(
    Line(points = {{-14, -63}, {20, -63}, {20, -70}, {28, -70}}, color = {0, 0, 127}));
  connect(GasBusCO2Emission.y, TotalBusCO2Emssion.u[2]) annotation(
    Line(points = {{-14, -65}, {20, -65}, {20, -70}, {28, -70}}, color = {0, 0, 127}));
  connect(HydrogenBusCO2Emission.y, TotalBusCO2Emssion.u[3]) annotation(
    Line(points = {{-14, -67}, {20, -67}, {20, -70}, {28, -70}}, color = {0, 0, 127}));
  connect(ElectricBusCO2Emission.y, TotalBusCO2Emssion.u[4]) annotation(
    Line(points = {{-14, -69}, {20, -69}, {20, -70}, {28, -70}}, color = {0, 0, 127}));
  connect(DieselBusCO2EmissionUpstream.y, TotalBusCO2Emssion.u[5]) annotation(
    Line(points = {{-14, -73}, {20, -73}, {20, -70}, {28, -70}}, color = {0, 0, 127}));
  connect(GasBusCO2EmissionUpstream.y, TotalBusCO2Emssion.u[6]) annotation(
    Line(points = {{-14, -75}, {20, -75}, {20, -70}, {28, -70}}, color = {0, 0, 127}));
  connect(HydrogenBusCO2EmissionUpstream.y, TotalBusCO2Emssion.u[7]) annotation(
    Line(points = {{-14, -77}, {20, -77}, {20, -70}, {28, -70}}, color = {0, 0, 127}));
  connect(ElectricBusCO2EmissionUpstream.y, TotalBusCO2Emssion.u[8]) annotation(
    Line(points = {{-14, -79}, {20, -79}, {20, -70}, {28, -70}}, color = {0, 0, 127}));
  connect(TotalBusCO2Emssion.y, DisplayHubPort.TotalBusCO2Emssion) annotation(
    Line(points = {{33, -70}, {103, -70}, {103, 20}}, color = {0, 0, 127}));
  connect(TotalCars.y, DisplayHubPort.NumberOfCars) annotation(
    Line(points = {{-6, 104}, {103, 104}, {103, 20}}, color = {0, 0, 127}));
 ...
 connect(TransportationHubPort.S004_PHeVCars, PHeVCars.NoOfVehicles) annotation(
    Line(points = {{-101, 18}, {-87, 18}, {-87, -3.5}, {-75, -3.5}}, color = {0, 0, 127}));
protected
  annotation(
