...
//flag for cars
  parameter Boolean BiogasCars_flag  = true;
  parameter Boolean PetrolCars_flag  = true;
  parameter Boolean DieselCars_flag  = true;
  parameter Boolean PHeVCars_flag    = true;
 
//Activate Variable Average KM Flag for Cars
  parameter Boolean ActivateVariableAverageKMperPetrolCar = true;
  parameter Boolean ActivateVariableAverageKMperDieselCar = true;
  parameter Boolean ActivateVariableAverageKMperPHeVCar = true;
  parameter Boolean ActivateVariableAverageKMperBioCar = true;
  parameter Boolean ActivateVariableAverageKMperElectricCar = true;

//Activate Variable Average KM Flag for Light Truck
  parameter Boolean ActivateVariableAverageKMperLightPetrolTruck = true;
  parameter Boolean ActivateVariableAverageKMperLightDieselTruck = true;
  parameter Boolean ActivateVariableAverageKMperLightPHeVTruck = true;
  parameter Boolean ActivateVariableAverageKMperLightBioTruck = true;
  parameter Boolean ActivateVariableAverageKMperLightElectricTruck = true;
  
//Activate Variable Average KM Flag for Heavy Truck
  parameter Boolean ActivateVariableAverageKMperHeavyPetrolTruck = true;
  parameter Boolean ActivateVariableAverageKMperHeavyDieselTruck = true;
  parameter Boolean ActivateVariableAverageKMperHeavyHydrogenTruck = true;
  parameter Boolean ActivateVariableAverageKMperHeavyBioTruck = true;
  parameter Boolean ActivateVariableAverageKMperHeavyElectricTruck = true;
...
//flag for LightTruck
  parameter Boolean LightBiogasTruck_flag = true;
  parameter Boolean LightPetrolTruck_flag = true;
  parameter Boolean LightDieselTruck_flag = true;
  parameter Boolean LightPHeVTruck_flag   = true;
  
//flag for HeavyLorries
  parameter Boolean HeavyTruckBiogas_flag    = true;
  parameter Boolean HeavyTruckPetrol_flag    = true;
  parameter Boolean HeavyTruckDiesel_flag    = true;
  parameter Boolean HeavyTruckHydrogen_flag  = true;
  
//flag for Buses
  parameter Boolean GasBus_flag = true;
  parameter Boolean DieselBus_flag = true;
  parameter Boolean HydrogenBus_flag = true;
...
//Combitable Flag for Bus Rate Logic
  ...
  //Emission Flags Fossil Combustion fo Cars
  ...
  parameter Boolean FossilCombustionFlagforElectricCar = true;
...
//Emission Flag for Upstream Fossil Combustion
  ...
  parameter Boolean UpstreamFossilCombustionFlagforElectricCar = false;
...
//Car Ban Year
  parameter Real DieselCarBanYear = 2025;
  parameter Real ElectricCarBanYear = 2119;
  parameter Real PetrolCarBanYear = 2028;
  parameter Real PHeVCarBanYear = 2028; 
  parameter Real BiogasCarBanYear = 2028;
//Light Truck Ban Year

  parameter Real LightPetrolTruckBanYear = 2028; 
  parameter Real LightDieselTruckBanYear = 2025; 
  parameter Real LightElectricTruckBanYear = 2100;
  parameter Real LightPHeVTruckBanYear = 2028; 
  parameter Real LightBioGasTruckBanYear = 2030;
  
//Heavy Truck Ban Year  
    
  parameter Real HeavyPetrolTruckBanYear = 2028; 
  parameter Real HeavyElectricTruckBanYear = 2100; 
  parameter Real HeavyBiogasTruckBanYear = 2028;
  parameter Real HeavyHydrogenTruckBanYear =2028;
  parameter Real HeavyDieselTruckBanYear = 2025;   
//Bus Ban Year
 
  parameter Real ElectricBusBanYear = 2100;
  parameter Real GasBusBanYear = 2028;
  parameter Real HydrogenBusBanYear = 2025;
  parameter Real DieselBusBanYear = 2025;
...
//Light Truck co2 Emission 
  parameter Real PetrolLightTruckGHGEmissionGmperKWh = 72*10^(-12);
