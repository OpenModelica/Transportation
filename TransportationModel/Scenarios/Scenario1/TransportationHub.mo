...
model TransportationHub
 ...
 //Light Truck
  TransportationModel.Components.TruckPool LightPetrolTrucks(ConversionPercentage = TP.ConversionPercentageforLightPetrolTruck, ConversionYear = TP.ConversionYearforLightPetrolTruck, InitialLevel = TP.InitialLevelofLightPetrolTruck,Trigger = TP.LightPetrolTruck_flag) annotation(
    Placement(visible = true, transformation(origin = {-137, 29}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
 ...
 //Light Truck Equations
  TransportationModel.LogicBox.RateLogic LightPetrolTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightPetrolTruckDepletionRate.txt"),FossilBanYear = TP.LightPetrolTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightPetrolTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckPetrolRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, 37}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic LightDieselTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckDepletionRate.txt"), FossilBanYear = TP.LightDieselTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckDieselRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, 17}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic LightPHeVTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightPHeVTruckDepletionRate.txt"),FossilBanYear = TP.LightPHeVTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightPHeVTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckPHeVRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -3}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic LightBioGasRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightBiogasTruckDepletionRate.txt"),FossilBanYear = TP.LightBioGasTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightBiogasTruckGrowthRate.txt"),CombitableFlag = TP.LightTruckBiogasRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -23}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic LightElectricTruckRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightElectricTruckGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightElectricTruckDepletionRate.txt"),CombitableFlag = TP.LightTruckElectricRateLogicFlag)  annotation(
...
//Heavy Truck Equations
  TransportationModel.LogicBox.RateLogic HeavyPetrolTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyPetrolTruckDepletionRate.txt"),FossilBanYear = TP.HeavyPetrolTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyPetrolTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckPetrolRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-213, -71}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic HeavyDieselTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyDieselTruckDepletionRate.txt"),FossilBanYear = TP.HeavyDieselTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyDieselTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckDieselRateLogicFlag    )  annotation(
    Placement(visible = true, transformation(origin = {-211, -91}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic HeavyHydrogenTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyHydrogenTruckDepletionRate.txt"),FossilBanYear = TP.HeavyHydrogenTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyHydrogenTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckHydrogenRateLogicFlag  )  annotation(
    Placement(visible = true, transformation(origin = {-211, -107}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic HeavyBioGasTruckRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyBioGasTruckDepletionRate.txt"),FossilBanYear = TP.HeavyBiogasTruckBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyBioGasTruckGrowthRate.txt"),CombitableFlag = TP.HeavyTruckBiogasRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -123}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic HeavyElectricTuckRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyElectricTruckGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyElectricTruckDepletionRate.txt"),CombitableFlag = TP.HeavyTruckElectricRateLogicFlag)  annotation(
...
//Buses Rate Equations
  TransportationModel.LogicBox.RateLogic DieselBusRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/DieselBusDepletionRate.txt"),FossilBanYear = TP.DieselBusBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/DieselBusGrowthRate.txt"), CombitableFlag = TP.DieselBusRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-211, -159}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  TransportationModel.LogicBox.RateLogic GasBusRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/GasBusDepletionRate.txt"),FossilBanYear = TP.GasBusBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/GasBusGrowthRate.txt"),CombitableFlag = TP.GasBusRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-171, -179}, extent = {{-7, -7}, {7, 7}}, rotation = 90)));
  TransportationModel.LogicBox.RateLogic HydrogenBusRateLogic(Depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HydrogenBusDepletionRate.txt"),FossilBanYear = TP.HydrogenBusBanYear, Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HydrogenBusGrowthRate.txt"),CombitableFlag = TP.HydrogenBusRateLogicFlag)  annotation(
    Placement(visible = true, transformation(origin = {-135, -179}, extent = {{-7, -7}, {7, 7}}, rotation = 90)));
  TransportationModel.LogicBox.ElectricVehicleRateLogic ElectricBusRateLogic(Growth = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/ElectricalBusGrowthRate.txt"), depletion = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/ElectricalBusDepletionRate.txt"),CombitableFlag = TP.ElectricBusRateLogicFlag)  annotation(
...
protected Modelica.Blocks.Math.MultiSum GrowthinElectricBusesAfterFossilBan(nu = 6) annotation(
  ...
  Modelica.Blocks.Sources.RealExpression StartSimulationTime(y = time)  annotation(
    Placement(visible = true, transformation(origin = {-317, 36}, extent = {{-23, -12}, {23, 12}}, rotation = 0)));
...
equation
 ...
 connect(LightPetrolTrucks.ToEV, multiSum1.u[1]) annotation(
    Line(points = {{-122, 27}, {-66, 27}, {-66, -59}, {-78, -59}}, color = {0, 0, 127}));
 ...
 connect(HeavyPetrolTruckRateLogic.GrowthToElectricVehicle, GrowthinElectric_H_TruckAfterFossilBan.u[1]) annotation(
    Line(points = {{-205, -76}, {-194, -76}, {-194, -134}, {-152, -134}}, color = {0, 0, 127}));
 ...
 connect(HeavyPetrolTruckRateLogic.GrowthRate, HeavyPetrolTruckconversionProgramme.GrowthRate) annotation(
    Line(points = {{-205, -66}, {-191.5, -66}, {-191.5, -68}, {-178, -68}}, color = {0, 0, 127}));
 connect(HeavyPetrolTruckRateLogic.DepletionRate, HeavyPetrolTruckconversionProgramme.DepletionRate) annotation(
    Line(points = {{-205, -71}, {-190, -71}, {-190, -76}, {-178, -76}}, color = {0, 0, 127}));
