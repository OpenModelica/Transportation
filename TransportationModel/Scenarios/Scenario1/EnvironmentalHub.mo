...
model EnvironmentalHub
  ...
  TransportationModel.Interfaces.Bus DisplayHubPort annotation(
    Placement(visible = true, transformation(origin = {70, 20}, extent = {{-20, -20}, {20, 20}}, rotation = -90), iconTransformation(origin = {102, 2}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalCars(nu = 5) annotation(
    Placement(visible = true, transformation(origin = {-14, 100}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalLightTrucks(nu = 5) annotation(
    Placement(visible = true, transformation(origin = {-14, 77}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalBuses(nu = 4) annotation(
    Placement(visible = true, transformation(origin = {25.5, 63.5}, extent = {{-5.5, -5.5}, {5.5, 5.5}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalHeavyTruck(nu = 5) annotation(
    Placement(visible = true, transformation(origin = {25.5, 87.5}, extent = {{-5.5, -5.5}, {5.5, 5.5}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalCO2Emission(nu = 38)  annotation(
    Placement(visible = true, transformation(origin = {34, -7}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  TransportationModel.LogicBox.EnergyLogicBox BioCars(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforBioCar, BioCombustionEmissionFlag = TP.BioCombustionFlagforBioCar,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/BiogasCarEfficiency.txt"), EnergyperCarPerKM = TP.EnergyUseByBioGasCarperKM, FixedAverageKM = TP.AverageKMBiogasCarRuns, Flag = TP.ActivateVariableAverageKMperBioCar, FossilBanYear = TP.BiogasCarBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforBioCar, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForBioCars, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforBioCar)  annotation(
    Placement(visible = true, transformation(origin = {-65.5, 14.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox PetrolCars(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforPetrolCar, BioCombustionEmissionFlag = TP.BioCombustionFlagforPetrolCar,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/petrol_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPetrolCarperKM, FixedAverageKM = TP.AverageKMPetrolCarRuns, Flag = TP.ActivateVariableAverageKMperPetrolCar, FossilBanYear = TP.PetrolCarBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforPetrolCar, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForPetrolCars, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforPetrolCar)  annotation(
    Placement(visible = true, transformation(origin = {-72.5, 7.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox PHeVCars(BioCombustionEmissionFlag = TP.BioCombustionFlagforPHeVCar,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"),BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PHEV_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPHeVCarperKM, FixedAverageKM = TP.AverageKMPHeVCarRuns, Flag = TP.ActivateVariableAverageKMperPHeVCar, FossilBanYear = TP.PHeVCarBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforPHeVCar, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForPHeVCars, UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforPHeVCar, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforPHeVCar)  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBox DieselCars(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforDieselCar, BioCombustionEmissionFlag = TP.BioCombustionFlagforDieselCar,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/DieselBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/DieselBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/Diesel_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByDieselCarperKM, FixedAverageKM = TP.AverageKMDieselCarRuns, Flag = TP.ActivateVariableAverageKMperDieselCar, FossilBanYear = TP.DieselCarBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforDieselCar, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/Diesel_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/case1/Diesel_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForDieselCars, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforDieselCar)  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBox LightPetrolTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforLightPetrolTruck, BioCombustionEmissionFlag = TP.BioCombustionFlagforLightPetrolTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPetrolLightTrucksperKM, FixedAverageKM = TP.AverageKMLightPetrolTruckRuns,Flag = TP.ActivateVariableAverageKMperLightPetrolTruck, FossilBanYear = TP.LightPetrolTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforLightPetrolTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForLightPetrolTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforLightPetrolTruck)  annotation(
    Placement(visible = true, transformation(origin = {-91.5, -17.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
  
  TransportationModel.LogicBox.EnergyLogicBox LightDieselTrucks( UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforLightDieselTruck, BioCombustionEmissionFlag = TP.BioCombustionFlagforLightDieselTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByDieselLightTrucksperKM,FixedAverageKM = TP.AverageKMLightDieselTruckRuns, Flag = TP.ActivateVariableAverageKMperLightDieselTruck, FossilBanYear = TP.LightDieselTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforLightDieselTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForLightDieselTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforLightDieselTruck)  annotation(
    Placement(visible = true, transformation(origin = {-86.5, -23.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox LightPHeVTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforLightPHeVTruck, BioCombustionEmissionFlag = TP.BioCombustionFlagforLightPHeVTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightPHeVTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPHeVLightTrucksperKM,FixedAverageKM = TP.AverageKMLightPHeVTruckRuns, Flag = TP.ActivateVariableAverageKMperLightPHeVTruck, FossilBanYear = TP.LightPHeVTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforLightPHeVTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForLightPHeVTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforLightPHeVTruck )  annotation(
    Placement(visible = true, transformation(origin = {-91.5, -29.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox LightBioGasTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforLightBioTruck,  BioCombustionEmissionFlag = TP.BioCombustionFlagforLightBioTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByBioGasLightTrucksperKM,FixedAverageKM = TP.AverageKMLightBiogasTruckRuns, Flag = TP.ActivateVariableAverageKMperLightBioTruck, FossilBanYear = TP.LightBioGasTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforLightBioTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/Petrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForLightBioGasTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforLightBioTruck )  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBox HeavyPetrolTrucks(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHeavyPetrolTruck, BioCombustionEmissionFlag = TP.BioCombustionFlagforHeavyPetrolTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrol_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByPetrolHeavyTrucksperKM,FixedAverageKM = TP.AverageKMHeavyPetrolTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyPetrolTruck, FossilBanYear = TP.HeavyPetrolTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHeavyPetrolTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHeavyPetrolTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHeavyPetrolTruck )  annotation(
    Placement(visible = true, transformation(origin = {-73.5, -47.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));

  TransportationModel.LogicBox.EnergyLogicBox HeavyDieselTrucks( UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHeavyDieselTruck, BioCombustionEmissionFlag = TP.BioCombustionFlagforHeavyDieselTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyDieselTruckBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyDieselTruckBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyDieselTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByDieselHeavyTrucksperKM,FixedAverageKM = TP.AverageKMHeavyDieselTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyDieselTruck, FossilBanYear = TP.HeavyDieselTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHeavyDieselTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyDieselTruck_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyDieselTruck_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHeavyDieselTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHeavyDieselTruck )  annotation(
    Placement(visible = true, transformation(origin = {-81.5, -54.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox HeavyHydrogenTrucks( UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHeavyHydrogenTruck,BioCombustionEmissionFlag = TP.BioCombustionFlagforHeavyHydrogenTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrolBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyHydrogenTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByHydrogenHeavyTrucksperKM,FixedAverageKM = TP.AverageKMHeavyHydrogenTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyHydrogenTruck, FossilBanYear = TP.HeavyHydrogenTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHeavyHydrogenTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrol_FossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHeavyHydrogenTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHeavyHydrogenTruck )  annotation(
    Placement(visible = true, transformation(origin = {-73.5, -60.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));

  TransportationModel.LogicBox.EnergyLogicBox HeavyBioGasTrucks( UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHeavyBioTruck,BioCombustionEmissionFlag = TP.BioCombustionFlagforHeavyBioTruck,BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrol_FossilCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrolBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByBioGasHeavyTrucksperKM,FixedAverageKM = TP.AverageKMHeavyBiogasTruckRuns, Flag = TP.ActivateVariableAverageKMperHeavyBioTruck, FossilBanYear = TP.HeavyBiogasTruckBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHeavyBioTruck, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrol_FossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyTruckPetrol_efficientFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHeavyBioGasTrucks, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHeavyBioTruck)  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBox DieselBus(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforDieselBus, BioCombustionEmissionFlag = TP.BioCombustionFlagforDieselBus, BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckBioCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckBioCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/PHeVCarEfficiency.txt"), EnergyperCarPerKM = TP.EnergyUseByDieselBusperKM,FixedAverageKM = TP.AverageKMDieselBusRuns, Flag = TP.ActivateVariableAverageKMperDieselBus, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforDieselBus,FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForDieselBus , UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforDieselBus)  annotation(
    Placement(visible = true, transformation(origin = {-86.5, -83.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox GasBus(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforGasBus, BioCombustionEmissionFlag = TP.BioCombustionFlagforGasBus, BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByGasBusperKM,FixedAverageKM = TP.AverageKMGasBusRuns, Flag = TP.ActivateVariableAverageKMperGasBus, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforGasBus, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForGasBus  , UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforGasBus )  annotation(
    Placement(visible = true, transformation(origin = {-78.5, -89.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBox HydrogenBus(UpstreamBioCombustionEmissionFlag = TP.UpstreamBioCombustionFlagforHydrogenBus, BioCombustionEmissionFlag = TP.BioCombustionFlagforHydrogenBus, BioFuelComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), BioFuelCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByHydrogenBusperKM,FixedAverageKM = TP.AverageKMHydrogenBusRuns, Flag = TP.ActivateVariableAverageKMperHydrogenBus, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHydrogenBus, FossilComposition = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), FossilCompositionUpstream = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightDieselTruckFossilCompositionFactor.txt"), ReducedPercentage = TP.ReducedPercentageForHydrogenBus, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHydrogenBus)  annotation(
  ...
  TransportationModel.LogicBox.EnergyLogicBoxForElectricalVehicles ElectricalCars( EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/ElectricalCarEfficiency.txt"), EnergyperCarPerKM = TP.EnergyUseByElectricCarperKM,FixedAverageKM = TP.AverageKMElectricCarRuns, Flag = TP.ActivateVariableAverageKMperElectricCar, FossilBanYear = TP.ElectricCarBanYear, FossilCombustionEmissionFlag = TP.FossilCombustionFlagforElectricalCar, ReducedAverageKMforElectricVehicles = TP.ReducedPercentageForElectricCars,UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforElectricalCar)  annotation(
    Placement(visible = true, transformation(origin = {-65.5, -10.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
  
  TransportationModel.LogicBox.EnergyLogicBoxForElectricalVehicles LightElectricTrucks( FossilCombustionEmissionFlag = TP.FossilCombustionFlagforLightElectricTruck, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforLightElectricTruck, EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightBioTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByElectricLightTrucksperKM,FixedAverageKM = TP.AverageKMLightElectricTruckRuns, ReducedAverageKMforElectricVehicles = TP.ReducedPercentageForLightElectricTrucks, Flag = TP.ActivateVariableAverageKMperLightElectricTruck)  annotation(
    Placement(visible = true, transformation(origin = {-91.5, -41.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
  
  TransportationModel.LogicBox.EnergyLogicBoxForElectricalVehicles HeavyElectricTrucks(FossilCombustionEmissionFlag = TP.FossilCombustionFlagforHeavyElectricTruck, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforHeavyElectricTruck, FixedAverageKM = TP.AverageKMHeavyElectricTruckRuns, EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/HeavyElectricTruck_efficientFactor.txt"), EnergyperCarPerKM = TP.EnergyUseByElectricHeavyTrucksperKM, ReducedAverageKMforElectricVehicles = TP.ReducedPercentageForHeavyElectricTrucks, Flag = TP.ActivateVariableAverageKMperHeavyElectricTruck )  annotation(
    Placement(visible = true, transformation(origin = {-73.5, -74.5}, extent = {{-2.5, -2.5}, {2.5, 2.5}}, rotation = 0)));
 
  TransportationModel.LogicBox.EnergyLogicBoxForElectricalVehicles ElectricBus(FossilCombustionEmissionFlag = TP.FossilCombustionFlagforElectricBus, UpstreamFossilCombustionEmissionFlag = TP.UpstreamFossilCombustionFlagforElectricBus, FixedAverageKM = TP.AverageKMElectricBusRuns, EfficiencyFactor = Modelica.Utilities.Files.loadResource("modelica://TransportationModel/Resource/Case1/LightBioTruck_efficientFactor.txt"),EnergyperCarPerKM = TP.EnergyUseByElectricBusperKM, ReducedAverageKMforElectricVehicles = TP.ReducedPercentageForElectricBus, Flag = TP.ActivateVariableAverageKMperElectricBus)  annotation(
  ...
  Modelica.Blocks.Math.MultiSum TotalCarsCO2Emission(nu = 10) annotation(
    Placement(visible = true, transformation(origin = {33.5, 9.5}, extent = {{-4.5, -4.5}, {4.5, 4.5}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalLightTrucksCO2Emission(nu = 10) annotation(
    Placement(visible = true, transformation(origin = {34, -26}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalHeavyTrucksCO2Emission(nu = 10) annotation(
    Placement(visible = true, transformation(origin = {35, -47}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Blocks.Math.MultiSum TotalBusCO2Emssion(nu = 8) annotation(
    Placement(visible = true, transformation(origin = {35, -71}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
...
equation
  ...
  connect(TotalPHeVCarCombustionEnergy.y, PHeVCarsCO2Emissions.u) annotation(
    Line(points = {{-60, -3}, {-44.9, -3}, {-44.9, 10}, {-16, 10}}, color = {0, 0, 127}));
