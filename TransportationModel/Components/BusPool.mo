...
model BusPool
  ...
  TransportationModel.Interfaces.SignalOutPort VehicleNos annotation(
    Placement(visible = true, transformation(origin = {215, 129}, extent = {{-10, -10}, {10, 10}}, rotation = -90), iconTransformation(origin = {95.5, 1.5}, extent = {{-5.5, -5.5}, {5.5, 5.5}}, rotation = 0)));
  ...
  TransportationModel.LogicBox.VehicleOutput vehicleOutput annotation(
    Placement(visible = true, transformation(origin = {83.5, 140.5}, extent = {{-30.5, -30.5}, {30.5, 30.5}}, rotation = 0)));
algorithm
...
equation
  ...
  connect(VehicleLevel.y1, vehicleOutput.VehicleIn) annotation(
    Line(points = {{11, 138}, {28, 138}, {28, 144}, {50, 144}}, color = {0, 0, 127}));
  connect(vehicleOutput.VehicleOut, VehicleNos) annotation(
    Line(points = {{117, 144}, {215, 144}, {215, 129}}, color = {0, 0, 127}));
protected
  annotation(
