...
record TransportationParameter_S3
//Average KMs
...
//Car Ban Year
  parameter Real DieselCarBanYear = 2024;
  parameter Real ElectricCarBanYear = 2119;
  parameter Real PetrolCarBanYear = 2028;
  parameter Real PHeVCarBanYear = 2030; 
  parameter Real BiogasCarBanYear = 2027;
//Light Truck Ban Year

  parameter Real LightPetrolTruckBanYear = 2027; 
  parameter Real LightDieselTruckBanYear = 2023; 
  parameter Real LightElectricTruckBanYear = 2100;
  parameter Real LightPHeVTruckBanYear = 2030; 
  parameter Real LightBioGasTruckBanYear = 2024;
//Heavy Truck Ban Year  
    
  parameter Real HeavyPetrolTruckBanYear = 2025; 
  parameter Real HeavyElectricTruckBanYear = 2100; 
  parameter Real HeavyBiogasTruckBanYear = 2022;
  parameter Real HeavyHydrogenTruckBanYear =2028;
  parameter Real HeavyDieselTruckBanYear = 2026;   
//Bus Ban Year
 
  parameter Real ElectricBusBanYear = 2100;
  parameter Real GasBusBanYear = 2030;
  parameter Real HydrogenBusBanYear = 2028;
  parameter Real DieselBusBanYear = 2024;
...
end TransportationParameter_S3;
